...
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("~/.dotfiles/config/rofi/scripts/wallpaper-selector.sh"), { locked = true })
hl.bind(mainMod .. " + P", hl.dsp.exec_cmd("~/.dotfiles/config/rofi/scripts/power-menu.sh"), { locked = true })
